...
from dataset import Lipsync3DDataset, Lipsync3DMeshDataset
...
if __name__ == '__main__':
    ...
    for epoch in range(opt.num_epoch):
        ...
        if epoch % opt.checkpoint_interval == 0 and epoch != 0:
            torch.save(model.module.state_dict(), os.path.join(opt.tgt_dir, 'mesh_checkpoint', 'checkpoint_{}.pth'.format(epoch)))
            print("Checkpoint saved")

    torch.save(model.module.state_dict(), os.path.join(opt.tgt_dir, 'mesh.pth'))
